"""
Django settings for closedCircuitChatbot project.
...
LOGGING = {
    ...
    'loggers': {
        ...
        'myproject.middleware': {  # Middleware loglarını kaydetmek için
            'handlers': ['file'],
            'level': 'INFO',
            'propagate': True,
        },
...
MIDDLEWARE = [
    ...
    'closedCircuitChatbot.middleware.ProfilingMiddleware',  # Middleware'i buraya ekleyin
]

ROOT_URLCONF = 'closedCircuitChatbot.urls'
...
WSGI_APPLICATION = 'closedCircuitChatbot.wsgi.application'
